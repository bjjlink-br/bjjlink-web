...
export function ProfileSettings({
  ...
  const userPhoto = components.find(
    (component) => component.type === "PROFILE",
  ) as any;
  ...
  return (
    <div className="space-y-6 w-full">
      ...
      <div className="flex items-start justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <span
              className={`inline-block mt-1.5 px-3 py-0.5 rounded-full text-xs font-medium ${getStatusColor(user.status)}`}
            >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="space-y-2">
          <Label className="text-gray-400 text-xs" htmlFor="username">
            {t("username")}
          </Label>
          <Input
            className="bg-gray-800 border border-gray-600 text-gray-100"
