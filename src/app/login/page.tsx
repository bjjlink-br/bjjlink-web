        ...
        <div className="flex flex-col gap-4 items-center justify-center bg-gray-1300 md:py-10">
            <div className="w-full max-w-md p-8 space-y-6 bg-gray-900 rounded-lg shadow-xl">
                <div className="space-y-1 text-left">
                    <h1 className="text-3xl font-medium text-gray-50 font-primary">Seja bem-vindo!</h1>
                    <p className="text-gray-200 text-sm font-normal">Yorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                </div>
                <Separator className="bg-gray-600" />
                <h2 className='text-2xl text-gray-50'>Entre Agora:</h2>

                <LoginForm onSubmit={handleLoginSubmit} />
                <p className="text-sm text-center text-gray-400 font-sans">
                    Quando criar conta, você está concordando com os{' '}
                    <Link href="#" className="text-brand-blue-500 underline">
                        termos e condições
                    </Link>{' '}
                    da plataforma e leu nosso{' '}
                    <Link href="#" className="text-brand-blue-500 underline">
            ...
            <div className='pb-8 md:pb-2'>
                <p className="text-sm text-center text-gray-50">
                    ...
                    <Link href="#" className="text-brand-blue-500 hover:underline">
                        Cadastre-se
                    </Link>
                </p>
            </div>
